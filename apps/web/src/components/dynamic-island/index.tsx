...
const DynamicIslandContent = ({
  ...
  return (
    <motion.div
      id={id}
      className="mx-auto h-0 w-0 items-center justify-center border  text-center text-card-foreground transition duration-300 ease-in-out hover:shadow-md bg-card"
      animate={{
