  ...
  const socials = [
    {
      ...
      href: "#",
      icon: (
        <Icons.twitter className="h-5 w-5 text-muted dark:text-muted-dark hover:text-black" />
      ),
    },
    {
      title: "github",
      href: "#",
      icon: (
        <Icons.gitHub className="h-5 w-5 text-muted dark:text-muted-dark hover:text-black" />
      ),
    },
    {
      title: "linkedin",
        ...
        <div className="mx-auto w-full max-w-md">
          <div>
            ...
            <p className="mt-4 text-muted dark:text-muted-dark  text-sm max-w-sm">
              Please reach out to us and we will get back to you asap!
            </p>
          </div>
