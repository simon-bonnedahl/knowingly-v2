    ...
    isClient && (
      ...
      >
        {theme === "light" && (
          ...
          >
            <Icons.sun className="h-4 w-4 flex-shrink-0  dark:text-neutral-500 text-neutral-700" />
          </motion.div>
        )}
        ...
        {theme === "dark" && (
          ...
          >
            <Icons.moon className="h-4 w-4   flex-shrink-0  dark:text-neutral-500 text-neutral-700" />
          </motion.div>
        )}
