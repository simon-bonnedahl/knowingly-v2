  ...
  const features = [
    {
      ...
      icon: <Icons.apple className="size-6"/>,
    },
    {
      title: "Ease of use",
      description:
        "It's as easy as using an Apple, and as expensive as buying one.",
      icon: <Icons.buildingCommunity className="size-6"/>,
    },
    {
      title: "Pricing like no other",
      description:
        "Our prices are best in the market. No cap, no lock, no credit card required.",
      icon: <Icons.chevronUp className="size-6"/>,
    },
    {
      title: "100% Uptime guarantee",
      description: "We just cannot be taken down by anyone.",
      icon: <Icons.copy className="size-6"/>,
    },
    {
      title: "Multi-tenant Architecture",
      description: "You can simply share passwords instead of buying new seats",
      icon: <Icons.chevronsRight className="size-6"/>,
    },
    {
      title: "24/7 Customer Support",
      description:
        "We are available a 100% of the time. Atleast our AI Agents are.",
      icon: <Icons.heartHandshake  className="size-6"/>,
    },
    {
    ...
    },
    {
      ...
      icon: <Icons.adjustmentsHorizontal className="size-6"/>,
    },
  ];
  return (
