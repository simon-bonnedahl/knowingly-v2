...
export function Pricing() {
  ...
  return (
    <div className="relative">
      ...
      <div className="mx-auto mt-4 md:mt-20  grid relative z-20 grid-cols-1 gap-4 items-center  lg:grid-cols-3">
          ...
          <div
            ...
            className={cn(
              tier.featured
                ...
                : " bg-white dark:bg-black border border-neutral-200",
