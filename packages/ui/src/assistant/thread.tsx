...
import type {
  BranchPickerPrimitiveRootProps} from "@assistant-ui/react";
import {
  ActionBarPrimitive,
  ...
  return (
    <ThreadPrimitive.Root className="bg-background h-full">
      <ThreadPrimitive.Viewport className="flex h-full flex-col items-center overflow-y-scroll scroll-smooth px-4 pt-8">
        ...
        <div className="sticky bottom-0 mt-4 flex w-full  flex-grow flex-col items-center justify-end rounded-t-lg  pb-4  bg-card">
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="relative grid w-full max-w-2xl grid-cols-[auto_auto_1fr] grid-rows-[auto_1fr] py-4">
      ...
      <div className="text-foreground col-span-2 col-start-2 row-start-1 max-w-xl break-words leading-7 text-sm ">
