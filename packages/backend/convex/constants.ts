...
export const defaultPageContent = (type : string) => {
    switch (type) {
        ...
        default:
            return defaultCustomContent
    }
}
export const defaultPageIcon = (type: string) => {
    switch (type) {
        case "PROFILE":
            return "👤"
        case "EVENT":
...
export const defaultRoles = {
    owner : {
      ...
      permissions: {
        ...
        canEditCustomField: true,
        canDeleteCustomField: true,
